...
public class PageInfo {
	...
	public PageInfo(int msgCount, int limit, int pagingBarSize, int currentPage, int maxPage, int startPage,
			int endPage) {
		super();
	...
	public String toString() {
		return "PageInfo [msgCount=" + msgCount  + ", limit=" + limit
				+ ", pagingBarSize=" + pagingBarSize + ", currentPage=" + currentPage + ", maxPage=" + maxPage
