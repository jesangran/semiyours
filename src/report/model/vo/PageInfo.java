...
public class PageInfo {
	...
	private int reportCount; 	// 전체 게시글 수
	...
	public PageInfo(int reportCount, int limit, int pagingBarSize, int currentPage, int maxPage, int startPage,
			int endPage) {
		super();
	...
	public String toString() {
		return "PageInfo [reportCount=" + reportCount + ", limit=" + limit + ", pagingBarSize=" + pagingBarSize
