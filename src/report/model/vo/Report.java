...
public class Report {
	...
	public Report(int reportNo, String reportType, String reportReason, String reportCon, Date reportDate, int no) {
		super();
	...
	public Report(int reportNo, String reportType, String reportReason, String reportCon, Date reportDate,
	...
	public Report(String reportType, String reportReason, String reportCon, int no) {
		super();
		this.reportType = reportType;
		this.reportReason = reportReason;
		this.reportCon = reportCon;
